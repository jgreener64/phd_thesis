...
The plasmid for cyclin A2 with either a His tag or GST tag were transformed into \textit{E.\ coli} Tuner cells.
% Residue numbers
...
For the TR-FRET CDK2 titration a 392 \textmu L/well plate was used.
% Check
...
The plate was incubated for 1 hour and centrifuged at 800 rpm before being read with a plate reader.
...
His-tagged cyclin A2 (75 nM) was incubated on Sepharose fast flow beads in buffer X with 12\% DMSO.
% Sepharose?
...
This is also shown in Figure~\ref{fig:cdk2_structure}A.
...
% Mention the construct is not all of cyclin A2
% There are x surface-exposed cysteine residues on cyclin A2 (construct?).
...
Hence, initial purification was attempted for cyclin A2-GST K773 (single cysteine mutant).
% mutant code
...
The donor and acceptor fluorophores for the TR-FRET assay were switched so that the Eu anti-His antibody was targeted at cyclin A2 and CDK2 was dyed with Cy5 dye - see Figure~\ref{fig:tr_fret}A.
...
The difficulty of purifying cyclin A2 is likely due to the propensity of the protein to aggregate, possibly due to the large flexibility and a lack of stability in the absence of the binding partner.
...
This assay does not indicate that the compound is specific to the CDK2-cyclin A2 interaction however, as any effect that prevents proliferation will appear in the assay.
...
Carrying out the above experiments with cyclin E rather than cyclin A2 would give an idea of the specificity of allosteric modulation of the interaction of CDK2 with cyclins.
Knowledge of the different structures of cyclin A2 and E may also help elucidate the allosteric mechanism.
