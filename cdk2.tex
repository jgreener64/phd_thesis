...
The selected structure has the maximum sum of two distances across the opening of the pocket, .
This struture is energy minimised as described in (exprose experimental ref).
...
Using two different docking algorithms, AutoDock Vina and DOCK, .
...
% Mention cross-docking? In results

d1 = distance(struc['A'][180]["OH"], struc['A'][150]["NH1"])
d2 = distance(struc['A'][188]["OG"], struc['A'][165]["O"])
...
The plate was incubated for 1 hour and centrifuged at 800 g.
...
\item Anti-proliferation assay:
\item Kinase assay:
\item Mutagenesis:
\item Thermal shift assay:
