...
% \cite{Qi2012}? Go model, probably not
...
Classic work has shown that allosteric communication can be mediated by networks of residues conserved by evolution \cite{Suel2003}.
...
For example, the allostery of GPCRs has been studied in detail \cite{Wootten2013}.
...
Box 1: Challenges faced in the structure-based prediction of protein allostery.
