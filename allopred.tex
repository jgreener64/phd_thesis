...
The work is further described in \cite{Greener2015}.
...
We developed a computational procedure, AlloPred, which uses NMA to predict the allosteric pockets on a protein.
