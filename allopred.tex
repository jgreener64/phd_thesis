...
This chapter describes the development and validation of a computational approach, AlloPred, based on the perturbation of normal modes to predict allosteric sites on proteins.
...
The work is further described in Greener and Sternberg 2015 \cite{Greener2015}, on which this chapter is based.
...
Such methods will hopefully be developed and utilised more widely as allosteric prediction becomes more powerful.
