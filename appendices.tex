...
\addcontentsline{toc}{section}{AlloPred documentation}
...
\addcontentsline{toc}{section}{ExProSE documentation}
...
Install using \verb|Pkg.add("ProteinEnsembles")| from within Julia v0.5 or v0.6. Run using
...
\addcontentsline{toc}{section}{BioJulia Bio.Structure module}
...
The type hierarchy is based on Biopython \cite{Cock2009} and is shown in Figure~\ref{fig:model_structure}.
Examples of basic use cases for Bio.Structure are shown in Figure~\ref{fig:biojulia_example}.

As part of the development of Bio.Structure information was collected on existing packages with similar functionality in various programming languages.
